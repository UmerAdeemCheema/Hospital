            ...
            <CardHeader>
                <NameAndRatingContainer>
                    <ProfilePictureContainer>
                        {hospitalData &&
                            <ProfilePicture src="https://img.freepik.com/free-vector/people-walking-sitting-hospital-building-city-clinic-glass-exterior-flat-vector-illustration-medical-help-emergency-architecture-healthcare-concept_74855-10130.jpg?w=2000"   a={returnURLFromObjectOfStrings(hospitalData.hospitalImages)} alt={hospitalData.name} />}
                    </ProfilePictureContainer>
