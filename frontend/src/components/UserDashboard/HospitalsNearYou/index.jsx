                        ...
                        hospitals.map(hospital => (
                            <ChildCard >
                                <StyledLink to={`/${params.id}/userDashboard/hospitals/${hospital._id}`} key={hospital._id}>
                                    <ChildCardHeader>
                                        <ChildCardImage src="https://img.freepik.com/free-vector/people-walking-sitting-hospital-building-city-clinic-glass-exterior-flat-vector-illustration-medical-help-emergency-architecture-healthcare-concept_74855-10130.jpg?w=2000"    a="{returnURLFromObjectOfStrings(hospital.hospitalImages)}" alt={"Hospital"} />
                                    </ChildCardHeader>
                                    <ChildCardBody>
                                        <ChildCardTitle>
                                            <b>{hospital.name}</b>
