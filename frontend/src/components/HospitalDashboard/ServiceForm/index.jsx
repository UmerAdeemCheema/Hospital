...
const AddEvent = ({ open, setOpen, type, serviceCards, setServiceCards }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    let respBody = {
      ...
      method: "post",
      data: { topic, serviceCharge: charge, desc: description },
    };
    ...
    if (data) {
      ...
      var abc = serviceCards;

      abc.services.push(respBody.data);
