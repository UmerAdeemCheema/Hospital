...
const EditProfile = ({ open, setOpen }) => {
  ...
  if(responseObject.hospitalDescription){
    // setHospitalDescription(responseObject.hospitalDescription)
  }
      ...
      <ModalForm onSubmit={handleSubmit}>
        <ModalBody>
          <InputGroup>
            ...
            <Input type="text" id="hospitalName" value={responseObject.name} fluid disabled />
          </InputGroup>
          <InputGroup>
            <Label htmlFor="hospitalEmail">Email</Label>
            <Input type="email" id="hospitalEmail" value={responseObject.email} fluid disabled />
          </InputGroup>
          <InputGroup>
