...
route.post("/hospitalEventDetails", hospitalEventDetails);
route.post("/hospitalBedDetails", hospitalEventDetails);
route.post("/hospitalVacancyDetails", hospitalEventDetails);
route.post("/hospitalServiceDetails", hospitalEventDetails);
